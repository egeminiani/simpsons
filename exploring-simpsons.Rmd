...
palette <- c("#acba81ff", "#2a9430ff", "#ae6b1bff","#024CF0", "#28536bff", "#68aedeff", "#8928e8ff","#f25d30ff",
             ...
             "aquamarine3")
palette2 <- c("#6891AB", "#81d2c7ff", "#63D676", "#ffe579ff", "#ffaa60ff", "#ffc09fff", "#f994b6ff", "#b892ffff")
```
...
<img style="float: right;width: 120px;" src="Images/wrench2.png">
&nbsp;
...
topic6 <- "We read 'marge', 'boy', 'bart', 'lisa', 'stupid', and 'flanders', and we can't help thinking about **Homer**! Homer is, of course, the main character of this topic, followed by other secondary characters."
